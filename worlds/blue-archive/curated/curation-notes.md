...
- 新增 `completion-expansion.json`，补足基沃托斯政治模型、武装日常/光环耐久、主要学院与组织、凯撒集团/数秘术/头盔团、地点、剧情弧与 RP 切入点。
- 明确 characters 源分类为 0，因此新增内容不伪造完整学生名册，只扩展学院/组织/岗位和源中明示姓名的运行语义。
- 低置信/待复核：本地源只有 25 条，未覆盖全游戏主线、活动和学生 roster；canonTimeline 为空，未构造完整游戏年表。
